...
(let* ((sans-font (cond ((x-list-fonts "Hack") '(:font "Hack"))
       ...
       (padding (if org-beautify-theme-use-box-hack
                    `(:line-width 2 :color ,background-color)
                    nil))
  ...
  (custom-theme-set-faces 'org-beautify
                          ...
                          `(org-level-2 ((t (,@headline ,@sans-font :height 1.0 :box ,padding))))
                          `(org-level-1 ((t (,@headline ,@sans-font :height 1.1  :box ,padding :background ,background-color ))))
                          `(org-document-title ((t (:inherit org-level-1 :height 1.1 :underline nil :box ,padding))))
